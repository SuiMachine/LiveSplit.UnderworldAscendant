...
{
    public class UnderworldAscendantFactory : IComponentFactory
    {
        private UnderworldAscendantComponent _instance;
        ...
        {
            get { return "Automates load removal for Underworld Ascendant."; }
        }
        ...
        public IComponent Create(LiveSplitState state)
        {
            ...
            if (_instance != null && !_instance.Disposed)
            {
                ...
                MessageBox.Show(
                    "LiveSplit.UnderworldAscendent is already loaded in the " +
            ...
            return (_instance = new UnderworldAscendantComponent(state, createAsLayoutComponent));
        }
        ...
        {
            get { return "https://raw.githubusercontent.com/SuiMachine/LiveSplit.UnderworldAscendant/master/"; }
        }
        ...
        {
            get { return this.UpdateURL + "Components/update.LiveSplit.UnderworldAscendant.xml"; }
        }
    }
